...
export class Recipe {
  ...
  [
    ...
    new Recipe(0, 10, 'Pâtes au pesto',false,'primary', chefs[0], [
      new Task(0,'Faire cuire les pâtes al dente',true,'accent'),
      new Task(1,"Dans un mortier, pilez le basilic avec l'ail et les pignons jusqu'à obtention d'une crème lisse.", true, 'accent'),
      new Task(2, "Mettez la préparation dans un bol, puis ajouter l'huile peu à peu en fouettant.", true, 'accent'),
      new Task(3, "Rajoutez les fromage râpés, assaisonner et mélangez.", true, 'accent'),
    ...
    new Recipe(1,15, 'Salade César', false, 'primary', chefs[1], [
      new Task(0,'Lavez la salade.',true, 'accent'),
      new Task(1,"Faîtes cuire le poulet.", true, 'accent'),
      new Task(2,"Mélangez.", false, 'accent'),
    ]),

    new Recipe(2, 20, 'Fondant au chocolat', false, 'primary',chefs[2], [
      new Task(0, 'Faîtes fondre le chocolat.', true, 'accent'),
      new Task(1, "Enfournez le tout.", true, 'accent'),
